...
export default function GalleryGrid({ posts, onSelectPost }: GalleryGridProps) {
  if (posts.length === 0) {
    return (
      <div className="surface-panel flex flex-col items-center justify-center rounded-panel py-16 text-app-textMuted">
        ...
        <p className="text-lg font-medium text-app-text">No media found in this category</p>
      </div>
    );
  }
